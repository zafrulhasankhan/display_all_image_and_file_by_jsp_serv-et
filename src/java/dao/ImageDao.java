...
//private final String GET_DATA = "select id,name from imageupload where id='10'";
...
String GET_DATA=null;
   ...
   public String find(String name1){
       //this.ide=id;
         idee=name1;
        GET_DATA = "select id,name from imageupload where id="+idee+" ";
        return GET_DATA;
   }
